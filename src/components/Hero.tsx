...
const Hero = () => {
  return (
    <div className="w-full mt-20 px-6 md:px-32 flex flex-col gap-6 md:flex-row-reverse items-center overflow-hidden">
        ...
        <div className="md:w-fit flex flex-col items-center md:items-start gap-6">
          ...
          <button type="button" className="py-2 px-8 bg-cyan text-xl text-white font-bold rounded-full">Get Started</button>
        </div>
    </div>
  )
}
